...
file priorities to 0 in `add_torrent_params::file_priorities`__. It's OK to set the
...
See `add_torrent_params::flag_stop_when_ready`__. This flag will stop the torrent
...
__ reference-Core.html#file_priorities
...
__ reference-Core.html#flag_stop_when_ready
